    ...
    methods: {
      ...
      chartGen (id, chartType, structure, chartOptions, dataset, metadata, sectionIndex = 0) {
        if (structure && chartOptions && this.validCharts.includes(chartType)) {
          if (chartOptions.from_api) {
            ...
            return this.$axios(this.$axiosCallSetupService.getAxiosOptions(url))
              .then((result) => {
      ...
      async obsTETooltip (target, route, tooltip_list = [], removed_text_list = [], options = null) {
        ...
        if (target.options.rowData.cd_mun_ibge) { // Brasileiros ou Sobreviventes Atendidos pelo SUAS
          ...
          const [result, resultSUAS, resultIndicadores] = await Promise.all([
            this.$axios(this.$axiosCallSetupService.getAxiosOptions(url)),
            this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlSUAS)),
      ...
      async obsTITooltip (target, route, tooltip_list = [], removed_text_list = [], options = null) {
      ...
      async obsSSTTooltip (target, route, tooltip_list = [], removed_text_list = [], options = null) {
        let text = ''
        if (options && options.clickable) {
        ...
        if (target.options.rowData.codigo == 'sinan') {
          ...
          const [resultPeriodo, resultTipo, resultAtividade, resultObs1, resultObs2] = await Promise.all([this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlPeriodo)),
            this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlTipo)),
            this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlAtividade)),
            this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlObs1)),
            this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlObs2))])

          // this.$axios.all([this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlPeriodo)),
          //   this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlTipo)),
          //   this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlAtividade)),
          //   this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlObs1)),
          //   this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlObs2))])
      ...
      async obsTDTooltip (target, route, tooltip_list = [], removed_text_list = [], options = null) {
        let text = ''
        if (options && options.clickable) {
          text += "<p class='text-xs-right ma-0'><a href='" + this.$tooltipBuildingService.getUrlByPlace(target.options.rowData.cd_municipio_ibge_dv, route) + "' class='primary--text font-weight-black'>IR PARA</a></p>"
        }
        ...
        const [resultSaldoMunicipio, resultCBOAumento, resultCBODiminui, resultCNAEAumento, resultCNAEDiminui] = await Promise.all([
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlSaldoMunicipio)),
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlCBOAumento)),
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlCBODiminui)),
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlCNAEAumento)),
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlCNAEDiminui))
        ])
        //   this.$axios.all([
        //   this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlSaldoMunicipio)),
        //   this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlCBOAumento)),
      ...
      async obsCovidMunicipioTooltip (target, route, tooltip_list = [], removed_text_list = [], options = null) {
        ...
        const [resultCovidMun, resultDenunciaMPT] = await Promise.all([
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlCovidMunicipio)),
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlDenunciaMPT))
        ])
        // this.$axios.all([
        // this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlCovidMunicipio)),
        // this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlDenunciaMPT)),
        // this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlAcoesMPT)),
        // this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlDestinacaoMPT))])
      ...
      async obsCovidRegicTextTooltip (target, showDadosSaude = false) {
        ...
        const [resultRegic, resultArranjo] = await Promise.all([
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlRegic)),
          this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlArranjo))
        ])
        // this.$axios.all([this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlRegic)),
        // this.$axios(this.$axiosCallSetupService.getAxiosOptions(urlArranjo))])
