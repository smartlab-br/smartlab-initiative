<template>
  <v-layout row wrap class="pa-0">
            ...
            <v-layout pa-0 pt-4 row wrap>
              <v-flex xs12 sm6 md4 px-4>
                ...
                <v-layout v-if="dimParamsLoaded && ind_principais && unlockLoading" row wrap justify-center>
                  <FLPOMinicard v-for="(miniCardPrincipal, indexMinicardsPrincipal) in ind_principais"
              ...
              <v-flex xs12 sm6 md4 px-4>
                ...
                <v-layout v-if="dimParamsLoaded && ind_principais_compare && unlockLoading" row wrap justify-center>
                  <FLPOMinicard v-for="(miniCardPrincipal, indexMinicardsPrincipal) in ind_principais_compare"
                    :key="'minicard_principal_'+indexMinicardsPrincipal"
                    :structure="miniCardPrincipal" :customFunctions="custom_functions"
                    :customParams="customParams" :row-class="miniCardPrincipal.rowClass"
                    @showSnackbar="snackAlert">
    ...
    <FLPODotNav :sections="sections"></FLPODotNav>
