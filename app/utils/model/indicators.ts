...
export class Indicators {
  ...
  melt (dataset: Record<string, any>[], value_field: string, layer_fields: string[], layer_field: string, label_fields: string[], label_field:string, value_function: string | null) {
    const meltedDS = []
  ...
  cast (dataset: Record<string, any>[], col_fields: string[], value_field: string, layer_field: string, fmt_value_field: string| null = null, det_value_field: string | null = null) {
  ...
  getMinMax (dataset: Record<string, any>[], value_field: string) {
    // Obtém o min e o max
  ...
  getMinMaxEachIndicator (dataset: Record<string, any>[], value_field: string) {
    // Obtém o min e o max
    const min = []
    const max = []
    for (const indxDS in dataset) {
