declare module "#app" {
  interface NuxtApp {
    // viewConfReader const/functions
    $yamlPath: string
    $loadYamlArray(currentStruct: any, yamlArray: any[], finalCbFunction: (context: any) => void): Promise<void>
    $fillDataStructure(structure: any, customParams: any, cbFunction: (dataset: Record<string, any>[], rules: Record<string, any>, structure: Record<string, any>, addedParams?: Record<string, any> | string, metadata?: Record<string, any>) => void, addedParams?: any): void
