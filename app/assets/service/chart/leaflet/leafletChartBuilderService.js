...
class LeafletChartBuilderService extends GeneralChartBuilderService {
    ...
    defaultLeafletTooltip(target, route, tooltip_list = [], removed_text_list = [], options = null) { 
        ...
        target.unbindPopup();
        target.bindPopup(this.$tooltipBuildingService.constructor.defaultTooltip(d, route, tooltip_list, removed_text_list, options)).openPopup();
      },
...
////////// TODO - move tooltips and cursor change outside the service classes
      changeCursor(image){
