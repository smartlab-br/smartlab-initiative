              ...
              <template slot="label" slot-scope="{ item }">
                <v-layout row>
                  ...
                  <v-flex v-if="item.type == 'observatorio'" grow>
                    <a class="white--text" @click="goToItem(item.url)">{{ $vuetify.breakpoint.smAndDown ? item.short_title : item.name }}</a>
                  </v-flex>
                  <v-flex v-else grow>
                    <a class="white--text" @click="goToItem(item.url)">{{ item.name }}</a>
                  </v-flex>
                </v-layout>
              </template>
            </v-treeview>
